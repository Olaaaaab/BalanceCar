...
#define PWM_TIM_CLK_ENABLE()  					__HAL_RCC_TIM5_CLK_ENABLE()
...
#define PWM_PRESCALER_COUNT     (720)
...
#define PWM_TIM_CH3_GPIO_CLK()             __HAL_RCC_GPIOA_CLK_ENABLE();
#define PWM_TIM_CH3_GPIO_PORT              GPIOA
#define PWM_TIM_CH3_PIN                    GPIO_PIN_2
